...
public class ContactHandler implements HttpHandler{
	public void handle(HttpExchange t) throws IOException{
		...
		String response = "<html>\r\n" + 
				...
				"                        Zip Code: <input type=\"text\" name=\"ZipCode\" value=\"Type your age\" size=\"120\" maxlength=\"2\"><br>\r\n" + 
				"                        Phone No.: <input type=\"text\" name=\"PhoneNo\" value=\"Type your age\" size=\"120\" maxlength=\"2\"><br>\r\n" + 
